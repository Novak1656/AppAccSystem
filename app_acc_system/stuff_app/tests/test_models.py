...
class StuffUsersModelTestCase(TestCase):
    ...
    def test_username_field(self):
        user = StuffUsers.objects.get(pk=1)
        user_meta = user._meta.get_field('username')
    ...
    def test_password_field(self):
        user = StuffUsers.objects.get(pk=1)
        user_meta = user._meta.get_field('password')
        field_label = user_meta.verbose_name
    ...
    def test_first_name_field(self):
        user = StuffUsers.objects.get(pk=1)
        user_meta = user._meta.get_field('first_name')
        field_label = user_meta.verbose_name
    ...
    def test_second_name_field(self):
        user = StuffUsers.objects.get(pk=1)
        user_meta = user._meta.get_field('second_name')
        field_label = user_meta.verbose_name
    ...
    def test_last_name_field(self):
        user = StuffUsers.objects.get(pk=1)
        user_meta = user._meta.get_field('last_name')
        field_label = user_meta.verbose_name
    ...
    def test_role_field(self):
        user = StuffUsers.objects.get(pk=1)
        user_meta = user._meta.get_field('role')
        field_label = user_meta.verbose_name
    ...
    def test_email_field(self):
        user = StuffUsers.objects.get(pk=1)
        user_meta = user._meta.get_field('email')
        field_label = user_meta.verbose_name
    ...
    def test_phone_field(self):
        user = StuffUsers.objects.get(pk=1)
        user_meta = user._meta.get_field('phone')
        field_label = user_meta.verbose_name
    ...
    def test_status_field(self):
        user = StuffUsers.objects.get(pk=1)
        user_meta = user._meta.get_field('status')
        field_label = user_meta.verbose_name
    ...
    def test_created_at_field(self):
        user = StuffUsers.objects.get(pk=1)
        user_meta = user._meta.get_field('created_at')
        field_label = user_meta.verbose_name
    ...
    def test_updated_at_field(self):
        user = StuffUsers.objects.get(pk=1)
        user_meta = user._meta.get_field('updated_at')
        field_label = user_meta.verbose_name
    ...
    def test_user_get_absolute_url(self):
        user = StuffUsers.objects.get(pk=1)
        absolute_url = f"/stuff/{user.username}/detail/"
        self.assertEqual(user.get_absolute_url(), absolute_url)

    def test_user_get_full_name(self):
        user = StuffUsers.objects.get(pk=1)
        full_name = f"{user.first_name} {user.second_name} {user.last_name}"
    ...
    def test_user_is_archive(self):
        user = StuffUsers.objects.get(pk=1)
        self.assertFalse(user.is_archive())

    def test_user_str(self):
        user = StuffUsers.objects.get(pk=1)
        true_str = f'{user.username}: {user.role}'
        self.assertEqual(str(user), true_str)
